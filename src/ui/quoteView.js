...
export const renderQuote = ({ text, author }) => {
  quoteElement.textContent = text;
  authorElement.textContent = `- ${author}`;
};

export const renderFavouriteButton = ({ isFavourite }) => {
...
export const bindFavouriteClick = (handler) => {
  favouriteBtn.addEventListener("click", handler);
};
